<?php
	$adresa="12276 Tamiami Trail East,Suite 501 Naples,Florida 34113"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2392062646;// Broj koji se poziva na dugme CALL US
